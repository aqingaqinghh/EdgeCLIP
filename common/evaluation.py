...
class Evaluator:
    ...
    def classify_prediction(cls, pred_mask, batch):
        ...
        #print(gt_mask0.shape,"query")
        #gt_mask = batch.get('support_masks').squeeze(1)
        #print(gt_mask.shape,"supp")
        ...
        #print(query_ignore_idx0.shape,"queryidx")
        #query_ignore_idx = batch.get('support_ignore_idxs')
        #print(query_ignore_idx.shape,"suppidx")
